...
namespace Surveya_Service
{
    public static class Helper
    {
        ...
        public static string SendMail(string to, string subject, string message, bool isHTML = false, string from = null, Attachment mailAttachment = null)
        {
            string overrideAddress = (ConfigurationManager.AppSettings["OverrideEmailAddress"] == null ? "" : ConfigurationManager.AppSettings["OverrideEmailAddress"].ToString());
